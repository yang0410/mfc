/****************************************************************************
**
** Namespace PCOMMSERVERLib generated by dumpcpp v5.13.0 using
...
// Actual coclasses
class PCOMMSERVERLIB_EXPORT PmacDevice : public QAxObject
{
public:
    PmacDevice(QObject *parent = 0)
    : QAxObject(parent)
    {
...
class PCOMMSERVERLIB_EXPORT PmacNC : public QAxObject
{
public:
    PmacNC(QObject *parent = 0)
    : QAxObject(parent)
    {
